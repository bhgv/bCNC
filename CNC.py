...
# VV
from GCode_parser.GParser import GParser
...
#        
#        global gparser
#        gparser.set_callback_dict(           # set callback-foos for executing different g-codes and situations
#         {
#           "pragma": pragma_cb,
#           "default": gcmd_cb,
#           "eol": eol_cb,
...
#        
#        def gcmd_cb(self, cmd, par=""):
#            if cmd not in ("eol", "init", "fini", "pragma"):
#                self.ln_tmp += " " + cmd + par
#
#        def pragma_cb(self, cmd, pragma):
#            #print pragma
...
#        gparser.Parse(Scanner(self.gtxt))
        ...
        for i,block in enumerate(self.blocks):
            ...
            for j,line in enumerate(block):
                ...
                cmds = line
#                gparser.init_parser()
#                print "== ln == %s, %s" % (line, gparser.do_parse(line), )
                #cmds = CNC.parseLine2(line)
                if cmds is None: continue
                if isinstance(cmds,str) or isinstance(cmds,unicode):
                    cmds = cmds.split()
